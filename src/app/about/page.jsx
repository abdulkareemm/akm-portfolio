      ...
      <div className="h-full overflow-y-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              I am a skilled MERN (MongoDB, Express.js, React.js, Node.js) stack
              developer with a passion for building efficient, scalable, and
              user-friendly web applications. With 2 of experience in software
              development, I have honed my expertise in each component of the
              MERN stack, allowing me to develop full-stack solutions that meet
              both client requirements and industry standards.
            </p>
            {/* BIOGRAPHY QUOTE */}
